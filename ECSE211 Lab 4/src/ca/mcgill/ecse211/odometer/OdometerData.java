/**
 * This class stores and provides a thread-safe access to 
 * the odometer data.
 *
...
public class OdometerData {
  ...
  /**
   * 
   * Default constructor. The constructor is private. A factory
   * is used instead, such that only one instance of this class 
   * is ever created.
   * 
   */
  ...
  /**
   * 
   * OdometerData factory. It returns an OdometerData instance 
   * and makes sure that only one instance is ever created. If 
   * the user tries to instantiate multiple objects, the method 
   * throws a MultipleOdometerDataException.
   * 
  ...
  /**
   * 
   * This method returns the Odometer data. It writes the current
   * position and orientation of the robot onto the odoData array.
   * odoData[0] = x, odoData[1] = y; odoData[2] = theta. 
   * 
   * @param void 
  ...
  /**
   * 
   * This method calls dx, dy and dtheta to the current values
   * of x, y and theta, respectively. This is useful when one
   * implements odometry. 
   * 
   * @param dx
   * @param dy
  ...
  /**
   * 
   * This method overrides the values of x, y and theta. It is
   * useful for odometry correction.
   * 
   * @param x 
   * @param y 
   * @param theta 
  ...
  /**
   * 
   * This method overrides x values on the odometer. This is
   * useful when only the x value has to be corrected on the
   * odometer. 
   * 
   * @param x 
   * @return void 
  ...
  /**
   * 
   * This method overrides y values on the odometer. This is useful 
   * when only the y value has to be corrected on the odometer.
   * 
  ...
  /**
   * 
   * This method overrides theta values on the odometer. This is useful 
   * when only the theta value has to be corrected on the odometer.  
   * 
   * @param theta 
   * @return void 
   * 

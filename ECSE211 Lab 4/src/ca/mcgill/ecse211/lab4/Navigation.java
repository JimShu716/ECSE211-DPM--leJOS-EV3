/**
 * This class extends Thread. It allows the robot to execute a simple navigation on a pre-defined
 * path. It first instantiates the robot's motors and the odometers, then it follows one of the four
 * maps that are implemented in the class.
 * 
 * Additionally, a constructor was set up for this class so that it can be implemented on the main
 * program, which is Lab4.
 * 
...
public class Navigation extends Thread {
   ...
   * total distance covered by the rotation.
   * 
   * @param radius
   * @param width
   * @param angle

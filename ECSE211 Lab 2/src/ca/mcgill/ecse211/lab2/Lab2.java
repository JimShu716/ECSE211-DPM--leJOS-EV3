/** 
 * This is the class that implements the other classes present in Lab2.
 * It first instantiates the motors and the light sensor, prompts the 
 * user to run the robot with or without correction, and updates the
 * x,y and theta values of the vehicle as it traces a square path on
 * the test surface. The classes implements Thread. 
 * 
